...
class UserPersonalDetailService(IPersonalDetailsService):
    ...
    async def create_personal_details(self, personal_details: UserPersonalDetailCreate, user_id: int) -> UserPersonalDetailResponse:
        try:
            ...
            personal_detail = await self.repo.create_personal_details(personal_details, user_id)
    ...
    async def update_personal_details(self, personal_details: UserPersonalDetailUpdate, user_id: int) -> UserPersonalDetailResponse:
        try:
            ...
            personal_detail = await self.repo.update_personal_details(personal_details, user_id)
            return UserPersonalDetailResponse.model_validate(personal_detail)
